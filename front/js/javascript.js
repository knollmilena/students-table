(() => {
  ...
  form.addEventListener('submit', (event) => {
    ...
    if (event.submitter === searchBtn) {
      ...
      if (dateEducation.value.trim() !== '') {newArr = interlinearFilter(listArray, 'studyStart', formaterNumber(dateEducation.value)); }
      if (dateBirth.value.trim() !== '') { newArr = interlinearFilter(listArray, 'birthday', formaterNumber(dateBirth.value)); }
